...
class ColorResources {
  ...
  static Color getGrey(BuildContext context) {
    return Provider.of<ThemeProvider>(context).darkTheme
        ? const Color(0xFF8B8484)
        : const Color(0xFFF1F1F1);
  }

  static Color getRed(BuildContext context) {
    return Provider.of<ThemeProvider>(context).darkTheme
        ? Color.fromARGB(255, 236, 110, 110)
  ...
  static Color getTextBg(BuildContext context) {
    return Provider.of<ThemeProvider>(context).darkTheme
        ? Color.fromARGB(255, 245, 249, 252)
        : Color.fromARGB(255, 7, 6, 6);
  }


    static Color getTextBgGreen(BuildContext context) {
    return Provider.of<ThemeProvider>(context).darkTheme
        ? Color.fromARGB(255, 3, 163, 70)
        : Color.fromARGB(255, 3, 163, 70);
  }
  ...
  static Color getSellColor(BuildContext context) {
    return Provider.of<ThemeProvider>(context).darkTheme
        ? Color.fromARGB(186, 77, 105, 165)
        : Color.fromARGB(80, 146, 255, 146);
  }
  ...
  static Color getGreen(BuildContext context) {
    return Provider.of<ThemeProvider>(context).darkTheme
        ? Color.fromARGB(255, 135, 245, 113)
  ...
  static Color getPrimary(BuildContext context) {
    return Provider.of<ThemeProvider>(context).darkTheme
        ...
        : const Color.fromARGB(255, 59, 74, 206);
  }

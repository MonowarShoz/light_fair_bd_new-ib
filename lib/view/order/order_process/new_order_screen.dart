...
import 'package:light_fair_bd_new/util/custom_text_field.dart';
...
import 'package:light_fair_bd_new/util/title_text.dart';
import 'package:light_fair_bd_new/view/base_widget/animated_custom_dialog.dart';
import 'package:light_fair_bd_new/view/base_widget/button/custom_button.dart';
...
import 'package:light_fair_bd_new/view/product_feed/product_item.dart';
                      ...
                      builder: (context) {
                        return AlertDialog(
                          title: Center(
                              child: Text(
                            'How To Order',
                            style: poppin.copyWith(fontSize: 16),
                          )),
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Text(
                                      ...
                                      style: poppin.copyWith(fontSize: 12),
                                    ),
                                  ),
                                  const Divider(),
                                  Padding(
                            ...
                            child: DropdownButtonHideUnderline(
                              child: DropdownButton(
                                ...
                                onChanged: (val) {
                                  ...
                                  ap.jwtTokenModel!.hccode!.substring(0, 9) ==
                                          '950200103'
                                      ? null
                                      : setState(() {
                                          sectionSelect = val;
                                ...
                                SizedBox(
                                  ...
                                  child: CarouselSlider.builder(
                                    ...
                                    itemBuilder: (context, index, page) {
                                        ...
                                        child: Container(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                                ...
                                                child: Padding(
                                                  padding:
                                                      const EdgeInsets.only(
                                                          ...
                                                          bottom: 8),
                                                  child: Text(
                                                    '${mobilFeedProvider.cartItems.values.toList()[index].sirdesc}',
                                                      ...
                                                      Row(
                                                        children: [
                                                          ...
                                                          Container(
                                                            ...
                                                            debugPrint(
                                                                'Hellow dropdown $selectedDropDownBtn');
                                                            newqtyController![index]
                                                                    .text
                                                                    .isNotEmpty
                                                                ? mobilFeedProvider.addToCart(
                                                                    prodId: mobilFeedProvider.cartItems.values.toList()[index].rsircode!,
                                                                    title: mobilFeedProvider.cartItems.values.toList()[index].sirdesc!,
                                                                    qty: newqtyController?[index].text.toDouble() ?? 1,
                                                                    // unit: value,
                                                                    unit: drpDownSelectedItem[index],
                                                                    price: mobilFeedProvider.cartItems.values.toList()[index].itmrat!,
                                                                    unitconv: mobilFeedProvider.cartItems.values.toList()[index].siruconf,
                                                                    batchno: mobilFeedProvider.cartItems.values.toList()[index].batchref1!)
                                                                : mobilFeedProvider.addToCart(
                                                                    prodId:
                                                                        mobilFeedProvider.cartItems.values.toList()[index].rsircode!,
                                                                    title:
                                                                        mobilFeedProvider.cartItems.values.toList()[index].sirdesc!,
                                                                    qty:
                                                                        1,
                                                                    ...
                                                                    unit:
                                                                        value,
                                                                    price:
                                                                        mobilFeedProvider.cartItems.values.toList()[index].itmrat!,
                                                                    unitconv:
                                                                        mobilFeedProvider.cartItems.values.toList()[index].siruconf,
                                                                    batchno:
                                                                        mobilFeedProvider.cartItems.values.toList()[index].batchref1!,
                                                                  );
                                                                },
                                                              ),
                                                          ),
                                                              ...
                                                              Flexible(
                                                                child: Text(
                                                                  newqtyController![
                                                                          ...
                                                                          .text
                                                                          .isEmpty
                                                                      ? '1 ${drpDownSelectedItem[index]}'
                                                                      : '${newqtyController![index].text} ${drpDownSelectedItem[index]}',
                                                                  style: robotoRegular
                                                                      .copyWith(
                                                                          fontSize:
                                                                              14),
                                                        ...
                                                        ? Flexible(
                                                            child: Row(
                                                              children: [
                                                                ...
                                                                Flexible(
                                                                  child: Text(
                                                                    '${drpDownSelectedItem[index] == 'CTN' ? (newqtyController![index].text.toDouble() * mobilFeedProvider.cartItems.values.toList()[index].itmrat!.toDouble() * mobilFeedProvider.cartItems.values.toList()[index].siruconf!.toDouble()) : (newqtyController![index].text.toDouble() * mobilFeedProvider.cartItems.values.toList()[index].itmrat!)} Taka',
                                                        ...
                                                        : Flexible(
                                                            child: Row(
                                                              children: [
                                                                ...
                                                                Flexible(
                                                                  child: Text(
                                                                    '${drpDownSelectedItem[index] == 'CTN' ? (mobilFeedProvider.cartItems.values.toList()[index].itmrat!.toDouble() * mobilFeedProvider.cartItems.values.toList()[index].siruconf!.toDouble()) : mobilFeedProvider.cartItems.values.toList()[index].itmrat!} Taka',
                                                              ...
                                                              child: Row(
                                                                children: [
                                                                  newqtyController![
                                                                      ...
                                                                      : Text(
                                                                          '${newqtyController![index].text} CTN = ',
                                                                          style:
                                                                              chakraPetch.copyWith(
                                                                            fontSize:
                                                                                14,
                                                                  ...
                                                                  newqtyController![
                                                                      ...
                                                                      ? Flexible(
                                                                          child:
                                                                              Text(
                                                                            '${mobilFeedProvider.cartItems.values.toList()[index].siruconf} PCS',
                                                                            style:
                                                                                chakraPetch.copyWith(
                                                                              fontSize: 14,
                                                                              fontWeight: FontWeight.w500,
                                                                      ...
                                                                      : Flexible(
                                                                          child:
                                                                              Text(
                                                                            '${(newqtyController![index].text.toDouble() * mobilFeedProvider.cartItems.values.toList()[index].siruconf!.toDouble())} PCS',
                                                                            style:
                                                                                chakraPetch.copyWith(
                                                                              fontSize: 14,
                                                                              fontWeight: FontWeight.w500,
                                              ...
                                              //     height: 40,
                                              //     child: TextField(
                                              //       controller: prodRemarkController![index],
                                              //       decoration: InputDecoration(border: OutlineInputBorder()),
                                              //       onChanged: (value) {
                                              //         mobilFeedProvider.addToCart(
                                              //           prodId: mobilFeedProvider.cartItems.values.toList()[index].rsircode!,
                                              //           title: mobilFeedProvider.cartItems.values.toList()[index].sirdesc!,
                                              //           qty: newqtyController?[index].text.toDouble(),
                                              //           unit: drpDownSelectedItem[index],
                                              //           price: mobilFeedProvider.cartItems.values.toList()[index].itmrat!,
                                              //           unitconv: mobilFeedProvider.cartItems.values.toList()[index].siruconf,
                                              //           batchno: mobilFeedProvider.cartItems.values.toList()[index].batchref1!,
                                              //           invremrk: prodRemarkController?[index].text,
                                              //         );
                                              //       },
                                              //     ),
                                              //   ),
                                      ...
                                      //   value: mobilFeedProvider.cartItems.values.toList()[index],
                                      //   child: CartProducts(
                                      //     prodId: mobilFeedProvider.cartItems.keys.toList()[index],
                                      //     qtycontrollers: newqtyController[index],
                                      //     //drp: dropdown[index],
                                      //   ),
                                      // );
                                    },
